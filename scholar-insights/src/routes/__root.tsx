  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <pre className="mt-4 max-h-40 overflow-auto rounded-md border bg-muted/40 p-3 text-left font-mono text-[11px] text-muted-foreground">
          {error.message}
        </pre>
  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/3cde9442-6133-4423-903f-3e6f8482dee3/id-preview-26386cda--6167460e-a19a-4d28-ab1f-52df03f5a4d4.lovable.app-1778610346710.png",
      },
      {
        name: "twitter:image",
        content:
